...
- No bribe-based referral spam. The share _is_ the daily score — don't bolt on "invite 3 friends for gems."
...
A share that doesn't convert to a _returning_ player is wasted distribution.
