...
2. **P1-2** (forecast sinks) and **P2-3** (contract feasibility) both extend the
   existing turn-report idea from *reporting* costs backward to *forecasting* them
