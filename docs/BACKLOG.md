...
| P2-3 | **Contract cards omit feasibility.** "Deliver 10 water → Kiruna Belt by day 12 · reward 252cr" doesn't show cargo cost, fuel to get there, estimated profit, or "days left" (deadlines are absolute). Expired contracts just vanish with a log line.                                                                                                                                                                                         | ✅ **Done 2026-08-02** (with E2-2). Offer cards carry `cost ~452cr · 5⛽ · est. +268cr · deposit 81cr · 8 days left`, active cards carry the countdown, and days-left turns amber at ≤ 2. Numbers come from one engine helper, `missionFeasibility`, so the card can't drift from what accepting actually costs. Earlier halves: expired contracts show "✗ deadline passed" inline instead of vanishing, and active contracts have one-click jump/deliver. |   M    |
